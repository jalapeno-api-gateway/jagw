...
func ConvertLsLink(doc arango.LSLink) LsLink {
	return LsLink{
		...
		NormalizedUnidirLinkDelay:      doc.NormalizedUnidirLinkDelay,
		NormalizedUnidirDelayVariation: doc.NormalizedUnidirDelayVariation,
		NormalizedUnidirPacketLoss:     doc.NormalizedUnidirPacketLoss,
	}
}
